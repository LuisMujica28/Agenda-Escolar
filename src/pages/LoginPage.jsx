    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-slate-900 via-slate-900 to-indigo-950 p-4 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md relative z-10 space-y-6">
                ...
                <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-2xl space-y-5 sm:space-y-6">
                    <div className="space-y-1">
                        <h2 className="text-lg sm:text-xl font-bold text-slate-100">Portal Institucional</h2>
                    ...
                    <button
                        ...
                        className="w-full bg-white hover:bg-slate-50 text-slate-800 font-bold py-3 px-3 sm:px-4 rounded-xl transition duration-200 shadow-lg shadow-white/5 flex items-center justify-center gap-2.5 sm:gap-3 text-xs sm:text-sm active:scale-[0.99] border border-slate-200 group cursor-pointer"
                    >
                        {googleLoading ? (
                            ...
                            <>
                                ...
                                <span className="text-slate-800 font-bold text-xs sm:text-sm">Ingresar con Google Institucional</span>
                            </>
                        )}
                    </button>
